  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        marginBottom: '1rem', paddingLeft: '0.65rem',
      }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {submission.subject && (
            ...
            <div style={{
              ...
              color: 'rgba(255,255,255,0.5)', marginTop: '0.2rem',
            }}>
              {submission.subject}
            </div>
          )}
        ...
        <div style={{
          ...
          <span style={{
            ...
            background: cfg.accentText,
            boxShadow: `0 0 6px ${cfg.accentText}`,
      ...
      {/* Progress section — ↑↑ BOOSTED label & percentage */}
      ...
      {/* Row 2: meta — ↑↑ BOOSTED icons & text */}
      <div style={{
        display: 'flex', alignItems: 'center',
        justifyContent: 'space-between', paddingLeft: '0.65rem',
      }}>
      ...
      {/* Result available banner — ↑↑ BOOSTED */}
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{
              ...
              color: 'rgba(255,255,255,0.42)', marginTop: '0.2rem',
            }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
            ...
            <button
              ...
              onMouseEnter={e => { if (!loading) { (e.currentTarget as HTMLButtonElement).style.background = 'rgba(255,255,255,0.09)'; (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(255,255,255,0.2)'; } }}
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '2.75rem 1rem' }}>
              ...
              <p style={{
                ...
                color: 'rgba(255,110,110,0.95)', marginBottom: '0.65rem',
              }}>
                {error}
              </p>
            ...
            <div style={{ textAlign: 'center', padding: '3.25rem 1rem' }}>
              ...
              {/* ↑↑ BOOSTED: empty state text */}
              <p style={{
                fontSize: '0.95rem', fontWeight: 700,
                color: 'rgba(255,255,255,0.55)', marginBottom: '0.4rem',
              }}>
                No submissions yet
              </p>
              <p style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {submissions.map((sub, i) => (
                <div key={sub.submissionId} className="sub-card-enter"
                  style={{ animationDelay: `${i * 0.07}s` }}>
                  <SubmissionCard
                    submission={sub}
                    index={i}
                    onClick={() => { setSelectedId(sub.submissionId); setModalOpen(true); }}
                  />
                </div>
              ))}
            </div>
